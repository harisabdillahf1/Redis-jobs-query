...
// Contoh penggunaan
addJobToQueue('Job Data ke-1');
addJobToQueue('Job Data ke-2');
addJobToQueue('Job Data ke-3');
addJobToQueue('Job Data ke-4');
addJobToQueue('Job Data ke-5');
addJobToQueue('Job Data ke-6');
